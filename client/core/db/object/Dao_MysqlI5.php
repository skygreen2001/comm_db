...
class Dao_MysqlI5 extends Dao implements IDaoNormal {
    ...
    public function connect($host=null,$port=null,$username=null,$password=null,$dbname=null) {
        ...
        if (strpos($this->character_set(),self::CHARACTER_LATIN1)!==false||strpos($this->character_set(),self::CHARACTER_GBK)!==false) {
            $this->change_character_set($character_code=self::CHARACTER_UTF8);
        }
    }
     ...
     */
    public function change_character_set($character_code=self::CHARACTER_UTF8) {
